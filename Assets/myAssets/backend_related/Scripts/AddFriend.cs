    ...
    public void AddFriendClick()
    {
        if (myUid.text != null && friendUid.text != null)
        {
            ...
            if (queryResult!= null)
            {
                ...
                {
                    string query1 = mysql.Insert("friendinfo", new string[] { "userid1", "userid2" }, new string[] { myUid.text, friendUid.text });
                    MySqlCommand cmd1 = new MySqlCommand(query1, mysql.mySqlConnection);
                    MySqlDataReader dataReader1 = cmd1.ExecuteReader();
                    dataReader1.Close();
                    
                    string query2 = mysql.Insert("friendinfo", new string[] { "userid1", "userid2" }, new string[] { friendUid.text, myUid.text });
